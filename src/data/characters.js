...
const CHARACTER_DATABASE = [
  ...
  { name: '香澄真昼', series: '星代', gender: '女', romaji: 'Kasumi Mahiru' },
  ...
  { name: '香澄夜空', series: '星代', gender: '女', romaji: 'Kasumi Yozora' },
  ...
  { name: '白百合辉夜', series: '友代', gender: '女', romaji: 'Shirayuri Kaguya' },
  { name: '白百合咲夜', series: '友代', gender: '女', romaji: 'Shirayuri Sakuya' },
